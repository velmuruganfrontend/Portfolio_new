...
`
const SelectionWork = styled.section`
${tw `mt-24`} 
`
        ...
        <Layout>
            <Main>
               <HomePage>
                   ...
                   <Intro>I'm a software engineer based in Chennai (India) specializing in developing (and occasionally designing) exceptional, high-quality websites and applications.</Intro>
                   <Intro>And also working as a freelancer.</Intro>
                   <Intro>Contact me anytime <a href="mailto:velmurugan.mg@outlook.com">for a coffee</a></Intro> 
                   <SocialLinks> 
               ...
               <SelectionWork>
                    <Center>
                       <UserName>A selection of work</UserName>
                       <Intro className="remove-icon">You can find more in the <Link to="/works">work overview</Link></Intro>   
                    </Center>
                    <ProjectList>
                        <Projectseprate>
